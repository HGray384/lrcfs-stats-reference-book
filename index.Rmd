--- 
title: "Probability and the likelihood ratio for non-experts"
author: "Harry Gray"
date: "`r Sys.Date()`"
...
link-citations: yes
description: "This book is a learning resource for statistical non-experts who would like to learn more about how probability is used to evaluate scientific evidence in the courtroom."
...
Roy Mudie at LRCFS has developed the R Shiny application which accompanies this book. This allows the html version of this book to contain interactive examples which we hope (and soon will test to see!) enhance the users' learning experience. This application can also be used as a standalone tool to engage with our statistical content. Roy has helped with many of the technical issues which have arisen behind the scenes and helped with how to visualise some of our content in a way that is intuitive. Thanks a lot for all of your work, Roy!

A big thanks goes to Pauline Mack, Joyce Klu, Heather Doran, Emma Comrie, Lucina Hackman, and Niamh Nic Daiéd as members of an internal review team at LRCFS. This team provided feedback on the content and appearance of the book which has significantly improved its presentation, conciseness, and clarity.
