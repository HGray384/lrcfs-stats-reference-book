tabHome = tabItem(tabName = "tabHome",
                  fluidRow(
                    box(title="Welcome to the Interactive probability and statistics app!", width = 12,
                        ...
                        p("If you would like to learn more about the ideas introduced here then you can read about them in our <a href='https://lrcfs.dundee.ac.uk/lr-book/'>interactive probability and statistics book</a>."),
