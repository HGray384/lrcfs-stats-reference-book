tabLRCalc = tabItem(tabName = "tabLRCalc",
                    ...
                    fluidRow(
                      box(title="Conditional probabilities", width=12,
                          column(width=6,
                                 numericInput("lrCalc_probHp", "Probability for \\(E\\) conditioned on \\(H_p\\)", min=0, max=1,
                                             value=0.1, step=0.01)
                          ),
                          column(width=6,
                                 numericInput("lrCalc_probHd", "Probability for \\(E\\) conditioned on \\(H_d\\)", min=0, max=1,
