...
output$display_dopingTest_probabilities_treeInfo = renderUI({
  ...
  tagList(
    ...
    p(paste0("In this interactive example we have a relevant population of ",populationSize," athletes. Using the base rate of ",baseRate," we expect ",doping," of these to be doping and ",notDoping," not to be doping.")),
