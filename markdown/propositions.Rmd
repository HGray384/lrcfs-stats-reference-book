...
There are plenty of situations in which simply negating the prosecution proposition is inappropriate however, e.g. when the defendant has a genuine alternative narrative for events. In this situation, the following assertion might be used for $H_d$:
