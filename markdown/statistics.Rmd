...
[maybe comment on prediction, hypothesis testing, evaluating scientific conclusions?]

## Data sources

Statistics can be computed on any source of data. This grants them a wide range of applications but also a large potential to be misused. 
