...
Now we have the foundation of statistics and probability theory to begin considering case situations. However, these situations require more than just numerical theory as they also involve investigative processes. In the analysis of forensic scientific evidence, this means merging probability and statistics with contextual information from both the prosecution and defence. The prosecution and defence's version of events are required to fully evidence that has been recovered. These statements, which are the disputed aspects of the case, are formalised into what are known as **propositions**. Propositions are used as anchors to focus the interpretation of the evidence. Propositions are the topic of the next chapter.
