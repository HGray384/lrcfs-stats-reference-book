...
Inferring from populations means drawing more general conclusions about populations based upon information gathered from samples. This is known as **statistical inference**, and it is done using **inferential statistics**.
...
We saw an example of this at the beginning of this chapter. We said that a coin was flipped 10 times and 7 of those resulted in heads. The sample proportion of heads, a descriptive statistic, is 0.7. If we use this sample statistic to make an inference about the population (e.g. the population proportion of heads, or the probability of heads) then the **estimate** 0.7 can be called an inferential statistic. This estimate is a single number summary, and we call such estimates **point estimates**.

## Assessing data sources

## Example: some data sources
