...
Fibre evidence is a term used for forensic evidence related to textile fibres which are shed from textile materials (such as an item of clothing) as a result of contact with another textile material or surface.
...
Fibre evidence is a useful evidence type because it can help to discriminate between assertions of physical contact which are made by prosecutors and persons of interest in an investigation. This evidence gives the fact finder information about a possible activity having taken place perhaps in a specific location.
...
GRADE evidence protocol: https://www.gradeworkinggroup.org/
