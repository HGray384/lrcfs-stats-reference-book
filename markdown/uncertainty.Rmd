...
Benjamin Franklin wrote this in 1789 in the context of the newly formed US constitution. Inadventantly, it is also a very helpful starting point to begin thinking about probability and statistics: by becoming familiar with uncertainty. 
...
The COVID-19 pandemic has been another reminder to us that medical diagnostic test results can be wrong, that official statistics do not count everything we are made to think they do, and that politicians can make claims about certain promises having been fulfilled when really they have not been. It has been demonstrated on a daily basis that understanding and communicating uncertainty has significant consequences when handling a public health emergency. 

The justice system has also been challenged by uncertainty: how to continue administering justice and what the justice process will look like in the future. Challenges arising from uncertainty in the pre-pandemic era also remain. We have imprisoned individuals being exonerated after expert testimony, which failed to appropriately incorporate uncertainty, is examined again. The impact of uncertainty is clear and serious. 

In society there are many situations in which we can better handle uncertainty. This will come with building a better understanding of uncertainty and having honest and open discussions about it. We begin that journey here by making a distinction between different types of uncertainty.
...
Despite uncertainty being everywhere, the communication surrounding it (particularly by experts) leaves much room for improvement. One reason for this is because communicating uncertainty is hard. There are some barriers which make it hard, and these barriers prevent experts from communicating it well. In this section, we take a look at some of those barriers.

- It is hard to explain the exact meaning of uncertainty. It often deals with thinking about hypothetical events in the future or past and considering hypothetical or real outcomes of those hypothetical events. This requires creativity and experience to get right, and even then it's easy to make mistakes. As explained before, the word uncertainty also means different things to people in the first place.

- It is hard to explain uncertainty in a way that is understandable. People have different preferences for different information formats. We have taken a more visual approach to formats in this text and that will work for some but not others. Understanding and switching between quantitative forms of uncertainty also requires a high level of numeracy and lots of practice.
...
- It feels hard to communicate uncertainty when the receiver trusts you. There is a perception among experts that expressing uncertainty diminishes trust and credibility. Fortunately, there is growing evidence to suggest that the opposite is true when communication is done well. 

- It is hard to communicate uncertainty when the receiver has to act on that information. From the receiver's perspective, they may want a definite answer so that their decision is easier. The communicator may also want to facilitate this. However, overlooking uncertainty removes agency from the receiver in their capacity to make their own decision. Moreover, ignoring uncertainty means that they will not be fully informed. 

It is important to mention these reasons because there may be times when you read through the following material and don't understand something. Or, maybe you understand it quite well but hear an expert not explaining it well (or think it is not well-explained here). Handling and communicating uncertainty is a learned skill and it is hard, but it does improve with practice.

The aim of the rest of this book is to give some insight into the way that uncertainty is handled in forensic science. When communicating uncertainty, is important that we are speaking the same language. The common language for uncertainty is probability, and this is what we look at in the next chapter. 
