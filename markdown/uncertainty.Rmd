...
The aim of the rest of this book is to give some insight into the way that uncertainty is handled in forensic science. Looking to the next section we will introduce a common language for describing uncertainty, probability.
