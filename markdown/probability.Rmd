...
```{r echo=FALSE}
knitr::include_app(paste0(SHINY_HOST,'/?_inputs_&sidebar="tabCoinToss"&embed=true'), height = '1100px')
```
...
```{r echo=FALSE}
knitr::include_app(paste0(SHINY_HOST,'/?_inputs_&sidebar="tabCoinTree"&embed=true'), height = '620px')
