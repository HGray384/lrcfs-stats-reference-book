...
```{r echo=FALSE}
knitr::include_app(paste0(SHINY_HOST,'/?_inputs_&sidebar=%22tabCoinToss%22&sidebarCollapsed=false&slider=50&sidebarItemExpanded=null&embed=true'), height = '1100px')
```
...
```{r echo=FALSE}
knitr::include_app(paste0(SHINY_HOST,'/?_inputs_&sidebar=%22tabCoinTree%22&sidebarCollapsed=false&slider=50&sidebarItemExpanded=null&embed=true'), height = '620px')
