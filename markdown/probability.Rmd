...
```{r echo=FALSE}
knitr::include_app(paste0(SHINY_HOST,'/?_inputs_&sidebar="tabCoinToss"&embed=true'), height = '1550px')
```
...
```{r echo=FALSE}
knitr::include_app(paste0(SHINY_HOST,'/?_inputs_&sidebar="tabCoinTree"&embed=true'), height = '490px')
