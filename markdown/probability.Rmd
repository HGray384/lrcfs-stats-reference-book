...
Below is an interactive example showing how coin tosses do things.

```
```{r echo=FALSE}
if(isDynamicOutput()){
  knitr::include_app(getInteractiveLink("tabCoinToss",NULL,TRUE), height = '1560px')
}
```
...
Below is an example showing how coin tosses do things.
...
To view all our interactive examples via our [Interactive Stats Book](`r getInteractiveLink()`) (`r getInteractiveLink()`).
...
```{r echo=FALSE}
knitr::include_app(getInteractiveLink("tabCoinTree",NULL,TRUE), height = '490px')
```
