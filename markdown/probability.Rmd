...
Example text based on isDynamicOutput function
...
if(isDynamicOutput()){
  ...
  print(paste("View this example online at",getInteractiveLink("tabCoinToss")))
  knitr::include_app(getInteractiveLink("tabCoinToss",TRUE), height = '1550px')

  
}else{
  
  print("This is a description of the image")
  print("#IMAGE#")
  print(paste("For an interactive example see",getInteractiveLink("tabCoinToss")))
