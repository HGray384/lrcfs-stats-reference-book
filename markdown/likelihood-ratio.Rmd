...
The LR is determined by the values of its underlying conditional probabilities (likelihoods). Type values into the calculator below to see how they affect the resulting LR. You may also try values greater than 1 for general likelihoods.
```
