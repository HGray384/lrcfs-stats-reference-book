...
Many case circumstances are more complicated than either of the simple diagrams in Figures \@ref(fig:serial-evidence-chain-diagram) and \@ref(fig:parallel-evidence-chain-diagram) and they often require a mixture of the two approaches. This means that in practice there are often conditional dependencies between the LRs and so Bayesian Networks are used.
